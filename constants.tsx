...
export const TOOLS: ToolMetadata[] = [
  // ... (keeping existing tools 1-20)
  {
    ...
    seoTitle: 'Free GPA Calculator Online – Calculate GPA from Marks & Percentage | Stravotech',
    seoDescription: 'Free GPA calculator online: calculate GPA from marks, convert GPA to percentage, use GPA calculator for university (4.0, 4.3, 10.0 scales). No sign-up required.',
    seoKeywords: 'free gpa calculator, gpa calculator online, how to calculate gpa from marks, gpa calculator university, gpa in percentage, 4.0 gpa calculator, cgpa calculator',
  ...
  },
  {
    ...
    category: 'student',
    icon: 'fa-percent',
    seoTitle: 'Free Percentage Calculator Online – Calculate % Changes Instantly | Stravotech',
    seoDescription: 'Accurate and fast online percentage calculator. Calculate percentage increases, find % changes, tips, and discounts instantly. Free to use with no sign-up.',
    seoKeywords: 'percentage calculator, free percentage calculator, percentage increase calculator, percent calculator online, percentage difference',
  ...
  },
  {
    ...
    category: 'student',
    icon: 'fa-calculator',
    seoTitle: 'Free Scientific Calculator Online – Advanced Mathematical Tool | Stravotech',
    seoDescription: 'Use our free online scientific calculator for complex math operations. Features trigonometric functions, logs, roots, and basic math. Perfect for students and engineers.',
    seoKeywords: 'scientific calculator, free scientific calculator, online scientific calculator, advanced math calculator, trigonometry calculator',
